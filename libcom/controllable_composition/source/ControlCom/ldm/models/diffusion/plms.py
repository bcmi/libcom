...
from libcom.controllable_composition.source.ControlCom.ldm.modules.diffusionmodules.util import make_ddim_sampling_parameters, make_ddim_timesteps, noise_like
...
class PLMSSampler(object):
    ...
    def plms_sampling(self, cond, shape,
        ...
        for i, step in enumerate(time_range):
            ...
            outs = self.p_sample_plms(img, cond, ts, index=index, mask=mask, use_original_steps=ddim_use_original_steps,
            ...
            if index % log_every_t == 0 or index == total_steps - 1:
                ...
                # intermediates['mask_inter'].append(mask)
    ...
    def p_sample_plms(self, x, c, t, index, mask=None, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if len(old_eps) == 0:
            ...
            # x_prev_new = torch.cat([x_prev, m_t], dim=1)
