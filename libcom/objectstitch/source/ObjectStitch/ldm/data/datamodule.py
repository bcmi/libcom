...
from libcom.objectstitch.source.ObjectStitch.ldm.data.base import Txt2ImgIterableBaseDataset
...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, num_workers=None, train=None, validation=None, test=None, predict=None,
